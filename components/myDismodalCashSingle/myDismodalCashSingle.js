...
Component({
  ...
  methods: {
    ...
    getApplyNumber: function (e) {
      ...
      console.log("eidididididpriie" , this.data.item.nxDgWillPriceOne, "wipritwowo", this.data.applyNumber, "subso", subtotal)
      this.setData({
        // level: 1,
    ...
    changeStandard: function (e) {
      console.log("changeStandardchangeStandard", e.currentTarget.dataset.name)
      var name = e.currentTarget.dataset.name;
      this.triggerEvent('changeStandard', {
        applyStandardName: name
      })
