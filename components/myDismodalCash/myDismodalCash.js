...
Component({
  ...
  methods: {
    ...
    getApplyNumber: function (e) {
      ...
      var three = this.data.item.nxDgWillPriceThreeWeight;
      var two = this.data.item.nxDgWillPriceTwoWeight;
      var onePrice = this.data.item.nxDgWillPriceOne;
      var twoPrice = this.data.item.nxDgWillPriceTwo;
      var  threePrice = this.data.item.nxDgWillPriceThree;
      console.log(three);
      console.log(two);
